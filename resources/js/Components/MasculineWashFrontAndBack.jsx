...
export default function MasculineWashFrontAndBack(props) {
  return (
    <BootstrapLayout>
        <div className='d-flex w-full col-lg-4 justify-content-center justify-content-lg-around align-items-center transition-transform duration-3000 transform hover:scale-105'>
            <div className='col-lg-3 justify-items-center' data-aos="zoom-in-up" data-aos-duration="3000">
                <img {...props} src={MWFront} alt="Masculine-Wash-Front" className='p-0' style={{ maxWidth: '190px', height: 'auto' }} />
            </div>
            <div className='col-lg-3 justify-items-center z-2' data-aos="zoom-in-up" data-aos-duration="3000">
